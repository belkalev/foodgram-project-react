# Generated by Django 3.2.15 on 2022-09-06 14:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True, validators=[django.core.validators.RegexValidator(message='Введено некорректное значение поля "username"', regex='^[\\w.@+-]+\\Z')], verbose_name='Имя пользователя')),
